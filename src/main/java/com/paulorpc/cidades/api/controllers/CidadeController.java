...
public class CidadeController {
	...
	// TODO FAZER TRATAMENTO DE EXCEÇÕES RETORNANDO CÓDIGO CORRETO DE STATUS HTTP
	...
	@GetMapping(value="/uf/qtde_por_estado")
	...
	@GetMapping(value="/uf/qtde_maior_menor_cidades")
	...
	public ResponseEntity<Response<List<CidadeDto>>> buscarPorFiltroColuna(@Valid @RequestBody FiltroDto filtroDto, BindingResult result) {
		...
		String coluna = EntidadeUtil.mapaColunasCidade(filtroDto.getColuna());
		if(coluna.isEmpty())
	...
	public ResponseEntity<Response<HashMap<String,Long>>> buscarRegistrosUnicosPorFiltroColuna(@PathVariable String coluna) {
		...
		String colunaMap = EntidadeUtil.mapaColunasCidade(coluna);
